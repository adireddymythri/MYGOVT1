    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('User', 'User'), ('Employee', 'Employee')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sector', models.CharField(choices=[('Infrastructure', 'Infrastructure'), ('Corruption', 'Corruption'), ('Pollution', 'Pollution'), ('Unemployment', 'Unemployment'), ('Others', 'Others')], max_length=50)),
